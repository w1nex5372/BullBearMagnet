      ...
      <Container>
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {featureCards.map((card, index) => (
            <Reveal key={card.title} delay={index * 0.04} y={10} disabled={index > 1}>
              <article className="group surface relative h-full overflow-hidden p-7 transition-all duration-300 hover:-translate-y-0.5 hover:border-cyan-300/14 hover:bg-white/[0.04] hover:shadow-[0_16px_32px_rgba(5,14,32,0.16)]">
